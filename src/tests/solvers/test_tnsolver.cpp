...
BOOST_AUTO_TEST_CASE( solveAnalytical )
{
  ...
  for ( int i = 1 ; i <= testCount ; i++ ) {
    ...
    _intOpt::set(solver.GetOptions(), "maxIterations", 100);
    _doubleOpt::set(solver.GetOptions(), "verbosity", 0.0 );
    _doubleOpt::set(solver.GetOptions(), "maxF", 0.00001 );
    solver.AddChoice( "x" );
    solver.AddChoice( "y" );
...
BOOST_AUTO_TEST_CASE( solveNumerical )
{
  ...
  for ( int i = 1 ; i <= testCount ; i++ ) {
    ...
    _doubleOpt::set(solver.GetOptions(), "verbosity", 0.0 );
    _doubleOpt::set(solver.GetOptions(), "maxF", 0.00001 );
    _matrixOpt::set(solver.GetOptions(), "derivativeDeltas" , _m( 1 , 1 , h ) );
...
BOOST_AUTO_TEST_CASE( intervalStepper1 )
{
  ...
  _intOpt::set(solver.GetOptions(), "maxIterations", 200);
  _doubleOpt::set(solver.GetOptions(), "verbosity", 0.0 );
  _doubleOpt::set(solver.GetOptions(), "maxF", 0.00001 );
  $$_f eq1($$_f(	      
			  _f::Add(
  ...
  _stepperOpt::set(solver.GetOptions(), "stepper", dynamic_pointer_cast<_stepper>(stepper)); 
  solver.AddChoice( "x" );
  solver.AddChoice( "y" );
